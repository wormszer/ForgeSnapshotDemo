...
namespace BeardedManStudios.Forge.Networking.UnityEditor
{
	...
	public class ForgeEditorField
	{
        ...
        public ForgeEditorField(string name = "", bool canRender = true, ForgeAcceptableFieldTypes type = ForgeAcceptableFieldTypes.BYTE, bool interpolate = false, float interpolateValue = 0f, bool snapshot = false)
		{
			this.FieldName = name;
			this.FieldType = type;
