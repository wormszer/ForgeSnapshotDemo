			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case NetworkCameraNetworkObject.IDENTITY:
						...
						break;
					case PlayerCharacterNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new PlayerCharacterNetworkObject(networker, id, frame);
						break;
					case ProjectileManagerNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new ProjectileManagerNetworkObject(networker, id, frame);
						break;
