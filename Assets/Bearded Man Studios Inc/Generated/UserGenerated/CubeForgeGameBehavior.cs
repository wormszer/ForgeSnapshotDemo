...
namespace BeardedManStudios.Forge.Networking.Generated
{
	public abstract partial class CubeForgeGameBehavior : NetworkBehavior
	{
		...
		/// <summary>
		/// InitializeMap(Vector3 minimum, Vector3 maximum, byte[] data)
		/// </summary>
		[GeneratedRPC(new string[]{"minimum", "maximum", "data"}, new string[]{"Vector3", "Vector3", "byte[]"})]
		public abstract void InitializeMap(RpcArgs args);
		/// <summary>
		/// CreatePrimitive(byte typebyte, Vector3 position)
		/// </summary>
		[GeneratedRPC(new string[]{"typebyte", "position"}, new string[]{"byte", "Vector3"})]
		public abstract void CreatePrimitive(RpcArgs args);
		/// <summary>
		/// DestroyPrimitive(Vector3 position)
		/// </summary>
		[GeneratedRPC(new string[]{"position"}, new string[]{"Vector3"})]
		public abstract void DestroyPrimitive(RpcArgs args);
		/// <summary>
		/// TestMe(string message)
		/// </summary>
		[GeneratedRPC(new string[]{"message"}, new string[]{"string"})]
