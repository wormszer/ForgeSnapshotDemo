...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	{
		public const byte RPC_SYNC_TIMESTEP = 0 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("SyncTimestep", SyncTimestep, typeof(long));
		...
		/// <summary>
		/// SyncTimestep(long Time)
		/// </summary>
		[GeneratedRPC(new string[]{"Time"}, new string[]{"long"})]
		public abstract void SyncTimestep(RpcArgs args);
