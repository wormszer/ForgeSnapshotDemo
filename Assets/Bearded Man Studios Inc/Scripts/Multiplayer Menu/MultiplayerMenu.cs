...
public class MultiplayerMenu : MonoBehaviour
{
    ...
    private List<NetWorker.BroadcastEndpoints> _AvailableServers = new List<NetWorker.BroadcastEndpoints>();

    private void LocalServerLocated(NetWorker.BroadcastEndpoints endpoint, NetWorker sender)
	{
        _AvailableServers.Add(endpoint);
	...
	private void Update()
	{
        ...
        {
            ipAddress.text = _AvailableServers[0].Address;
        }
    }
